...
pub fn thread_with_move_example(){
    let block_data: Vec<i32> = vec![1001, 1002, 1003, 1004, 1005, 1006, 1007];
...
async fn async_calculate_block_reward(block_time: u32, reward_date: u32) -> u32 {
    println!("Calculating block reward asynchronously...");
    sleep(TokioDuration::from_secs(1)).await;
    block_time * reward_date
}
